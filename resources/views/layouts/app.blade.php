        ...
        <footer class="bg-theme-dark text-white pt-20 pb-10 mt-auto border-t border-theme-main/30 relative overflow-hidden">
            ...
            <div class="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 mb-16">
                    ...
                    <div class="lg:col-span-4 space-y-6">
                        <a href="/" class="flex items-center gap-2">
                            ...
                            <span class="text-2xl font-black tracking-tighter text-white">Bajamas.</span>
                        </a>
                        <p class="text-gray-300 text-sm leading-relaxed pr-6">
                    ...
                    <div class="lg:col-span-2">
                        ...
                        <ul class="space-y-3 text-sm text-gray-300">
                            <li><a href="#" class="hover:text-theme-main hover:text-white hover:translate-x-1 transition-all inline-block">All Products</a></li>
                            <li><a href="#" class="hover:text-theme-main hover:text-white hover:translate-x-1 transition-all inline-block">Best Sellers</a></li>
                            <li><a href="#" class="hover:text-theme-main hover:text-white hover:translate-x-1 transition-all inline-block">New Arrivals</a></li>
                            <li><a href="#" class="hover:text-theme-main hover:text-white hover:translate-x-1 transition-all inline-block">Food Packaging</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="lg:col-span-2">
                        ...
                        <ul class="space-y-3 text-sm text-gray-300">
                            <li><a href="#" class="hover:text-theme-main hover:text-white hover:translate-x-1 transition-all inline-block">Help Center</a></li>
                            <li><a href="#" class="hover:text-theme-main hover:text-white hover:translate-x-1 transition-all inline-block">Shipping Info</a></li>
                            <li><a href="#" class="hover:text-theme-main hover:text-white hover:translate-x-1 transition-all inline-block">Returns & Refund</a></li>
                            <li><a href="#" class="hover:text-theme-main hover:text-white hover:translate-x-1 transition-all inline-block">Contact Us</a></li>
                        </ul>
                    </div>

                    <div class="lg:col-span-4">
                        <h4 class="text-lg font-bold text-white mb-4">Join Our Green Community 🌱</h4>
                        <p class="text-gray-300 text-sm mb-6">Ikuti perjalanan kami di media sosial untuk tips gaya hidup berkelanjutan.</p>
                        
                        <div class="flex gap-4 pt-2 mb-8">
                            <a href="#" class="w-12 h-12 rounded-xl bg-white/10 flex items-center justify-center transition-all duration-300 group hover:bg-[#1DA1F2] hover:-translate-y-1 hover:shadow-lg hover:shadow-[#1DA1F2]/30">
                        ...
                        <div>
                            <p class="text-xs font-bold text-gray-500 uppercase tracking-widest mb-3">Secure Payment</p>
                            <div class="flex gap-3 opacity-80 grayscale hover:grayscale-0 transition-all duration-500">
                ...
                <div class="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-400">
                    <p>&copy; {{ date('Y') }} Bajamas Store. All rights reserved.</p>
