                ...
                <div class="flex flex-col-reverse lg:flex-row items-center justify-between gap-16 lg:gap-0 max-w-[1600px] mx-auto">
                    ...
                    <div class="lg:w-1/2 space-y-8 text-center lg:text-left z-10">
                        <div class="reveal active">
                            <span class="inline-block px-5 py-2 rounded-full bg-theme-main/10 text-theme-dark text-sm font-bold tracking-[0.2em] mb-6 border border-theme-main/20 uppercase hover:bg-theme-main hover:text-white transition-colors duration-300 cursor-default">
                                New Drop 2026 🚀
                            </span>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
                        <div class="bg-white p-12 rounded-[2.5rem] border border-gray-100 shadow-xl shadow-gray-200/50 hover:shadow-2xl hover:shadow-theme-main/20 transition-all duration-500 hover:-translate-y-4 reveal delay-100 group">
                            <div class="w-24 h-24 bg-theme-bg text-theme-main rounded-3xl flex items-center justify-center mx-auto mb-10 group-hover:rotate-12 transition-transform duration-500">
                                <svg class="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 3.214L13 21l-2.286-6.857L5 12l5.714-3.214L13 3z"></path></svg>
                            </div>
