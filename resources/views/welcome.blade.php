...
<body class="antialiased bg-theme-bg text-theme-dark font-sans overflow-x-hidden">
    ...
    <nav
        class="flex items-center justify-between p-6 lg:px-12 fixed w-full z-50 bg-theme-bg/80 backdrop-blur-md animate-fade-up">
                ...
                @else
                    ...
                    @if (Route::has('register'))
                        <a href="{{ route('register') }}"
                            class="px-6 py-2.5 rounded-full bg-theme-dark text-white hover:bg-theme-main transition shadow-lg hover:shadow-theme-main/50 transform hover:-translate-y-0.5">Register
                            Now</a>
                    @endif
                @endauth
            @endif
    ...
    <main>
        <section class="relative pt-32 pb-20 lg:pt-40 lg:pb-28 px-6 lg:px-12 max-w-7xl mx-auto">
            <div class="flex flex-col-reverse lg:flex-row items-center justify-between gap-12 lg:gap-20">
                ...
                <div class="lg:w-5/12 space-y-8 text-center lg:text-left animate-fade-up delay-100">
                    <div>
                        <span
                            class="inline-block px-4 py-1.5 rounded-full bg-theme-main/20 text-theme-dark text-sm font-bold tracking-widest mb-4 border border-theme-soft uppercase">
                            New Drop 2024
                        </span>
                        <h1 class="text-5xl lg:text-7xl font-extrabold leading-none tracking-tight text-theme-dark">
                            Bajamas<br>
                            <span
                                class="text-transparent bg-clip-text bg-gradient-to-br from-theme-main via-theme-dark to-gray-800">Gaya
                                Keren, Bumi Aman.</span>
                        </h1>
                    </div>
                    <p class="text-lg text-gray-600 max-w-lg mx-auto lg:mx-0 leading-relaxed">
                        Produk eco-friendly yang bikin kamu tampil beda, tanpa bikin bumi menderita, didesain untuk
                        mereka yang berani tampil beda.
                    </p>

                    <div class="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-2">
                        <a href="{{ route('register') }}"
                            class="px-8 py-4 bg-theme-dark text-white rounded-xl font-bold text-lg hover:bg-theme-main transition shadow-xl hover:shadow-2xl transform hover:-translate-y-1">
                            Mulai Belanja 🔥
                        </a>
                        <a href="#features"
                            class="px-8 py-4 bg-white/50 border-2 border-theme-soft text-theme-dark rounded-xl font-bold text-lg hover:bg-white hover:border-theme-main transition">
                            Explore More
                        </a>
                    </div>
                </div>
                ...
                <div class="lg:w-7/12 relative animate-fade-up delay-300">
                    <div
                        class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[120%] h-[120%] bg-gradient-to-tr from-theme-main/30 to-theme-soft/30 rounded-full blur-[100px] -z-10 opacity-70">
                    </div>

                    <div
                        class="relative z-10 transform rotate-2 hover:rotate-0 transition-all duration-700 ease-out group">
                        <div class="rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white/50 relative">
                            <div
                                class="absolute inset-0 bg-theme-dark/10 group-hover:bg-transparent transition-colors z-10">
                            </div>
                            <img src="{{ asset('images/showcase.jpg') }}" alt="Dreaming Fears Eternal Collection"
        ...
        <section id="features" class="py-20 bg-white/60 border-y border-theme-soft relative overflow-hidden">
            <div class="max-w-7xl mx-auto px-6 lg:px-12 relative z-10">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
                    <div
                        class="bg-theme-bg p-8 rounded-2xl border border-theme-soft hover:shadow-xl transition hover:-translate-y-2 animate-fade-up delay-200 text-center group">
                        <div
                            class="w-16 h-16 bg-theme-main/20 text-theme-main rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:bg-theme-main group-hover:text-white transition-colors">
                        ...
                        <p class="text-gray-600">Bahan terbaik yang nyaman dipakai seharian, awet, dan tidak mudah
                            pudar.</p>
                    </div>
                    <div
                        class="bg-theme-bg p-8 rounded-2xl border border-theme-soft hover:shadow-xl transition hover:-translate-y-2 animate-fade-up delay-300 text-center group">
                        <div
                            class="w-16 h-16 bg-theme-main/20 text-theme-main rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:bg-theme-main group-hover:text-white transition-colors">
                            <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <p class="text-gray-600">Pesanan dikirim di hari yang sama. Gak pake lama, langsung sampai
                            tujuan.</p>
                    </div>
                    <div
                        class="bg-theme-bg p-8 rounded-2xl border border-theme-soft hover:shadow-xl transition hover:-translate-y-2 animate-fade-up delay-300 text-center group">
        ...
        <section class="py-24 bg-theme-dark relative overflow-hidden">
            ...
            <div class="max-w-4xl mx-auto text-center px-6 relative z-10 animate-fade-up">
                ...
                <a href="{{ route('register') }}"
                    class="inline-block px-10 py-4 bg-white text-theme-dark rounded-full font-bold text-xl hover:bg-theme-main hover:text-white transition shadow-2xl hover:shadow-white/20 transform hover:scale-105">
